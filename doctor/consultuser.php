            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <form class="col-sm-12" data-bitwarden-watching="1" action="consultuser.php" method="post">
                                            <?php 
                                    ...
                                    <form class="col-sm-12" data-bitwarden-watching="1" action="" method="post">
                                        ...
                                        <div class="form-row">
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <input type="number" class="form-control" name="edad_mascota" placeholder="Enter Age" readonly="readonly" required="" value="<?php echo $row['edad_mascota']?>">
                                            </div>
                                            <div class="col-sm-6 form-group">
