            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Crear Registro Visita</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Crear Registro Visita Paciente</li>
                        </ol>
                            ...
                            <form class="col-sm-12" data-bitwarden-watching="1" action="historiaclinica.php" method="post">
                                            <?php 
                            ...
                            <?php
                                ...
                                if(isset($_POST['uid'])){
                                    ...
                                    <form class="col-sm-12" data-bitwarden-watching="1" action="createvisita.php" method="post">
                                        ...
                                        <div class="form-row">
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="edad_mascota" placeholder="Enter Number" readonly="readonly" required="" value="<?php echo $row['edad_mascota']?>">
                                            </div>    
                                            <div class="col-sm-6 form-group">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-sm-6 form-check">
                                                ...
                                                <input type="text" class="form-control" name="temperatura" placeholder="Estado" readonly="readonly" required="" value="<?php echo $row['temperatura']?>">
                                            </div>
                                        </div>   
                                        <div class="form-row">
                                            <div class="col-sm-6 form-check">
                                                <label>Peso (Kg)</label><br>
                                                <input type="text" class="form-control" name="peso" placeholder="Estado" readonly="readonly" required="" value="<?php echo $row['peso']?>">
                                            </div>
                                        </div>
                                        <div class="form-row"> 
                                            <div class="col-sm-6 form-group">
                                    ...
                                    while($row = mysqli_fetch_array($resul)){
                                        ...
                                        ?>
                                            ...
                                            <div class="form-row">
                                                <div class="col-sm-6 form-group">
                                                    <label>Motivo</label>
                                                    <input id="some-textarea" class="form-control" rows="5" name="motivo_ing" placeholder="Enter text ..." readonly="readonly" required="" value="<?php echo $row['motivo_ing']?>">
                                                </div>
                                                <div class="col-sm-6 form-group">
                                                    <label>Fecha</label>
                                                    <input type="text" class="form-control" name="fecha" placeholder="Estado" readonly="readonly"  value="<?php echo $row['fecha']?>">
                                                </div>
                                            </div>
                                    <?php
                                    }
                                    ?>
                                        <br></br>
                                        <h2>Motivo Ingreso</h2>
                                            <div class="form-row"> 
                                                <div class="col-sm-7 form-group">
                                                    <label>Motivo de Visita</label>
                                                    <textarea id="some-textarea" class="form-control" rows="3" placeholder="Enter text ..." name="motivo_ing" required=""></textarea>
                                                </div>
                                            </div>
                                                <div class="col-sm-12 reset-button">
