            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Buscar Paciente</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Buscar Información Paciente</li>
                        </ol>
                            ...
                            <form class="col-sm-12" data-bitwarden-watching="1" action="searchuser.php" method="post">
                                            <?php 
                                    ...
                                    <form class="col-sm-12" data-bitwarden-watching="1" action="" method="post">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="telefono" placeholder="Enter Number" required="" value="<?php echo $row['telefono']?>">
                                            </div>
                                        </div>    
                                        <div class="form-row">    
                                            <div class="col-sm-6 form-group">
                                        ...
                                        <div class="form-row"> 
                                            ...
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="correo" placeholder="Email" required="" value="<?php echo $row['correo']?>">
                                            </div>
                                        </div>
                                        <div class="form-row">      
                                        ...
                                        <br>
                                        <div class="col-sm-12 reset-button">
                                                    <button type="submit" name="actualizar" class="btn btn-outline-success">Actualizar Datos</button>
                                                </div>
                                        <br></br>
                                        <br></br>
                                        <br></br>
...
if(isset($_POST['actualizar']))
{
 ...
 $correo=$_POST['correo'];
    ...
    $consultar="UPDATE usuarios_db SET 
        telefono='$_POST[telefono]',
        direccion='$_POST[direccion]',
        correo='$_POST[correo]'
        WHERE uid='$_POST[uid]'";
    ...
    {
        echo '<script type="text/javascript">alert("Los Datos No Pudieron Ser Actualizados !!")</script>';
    }
}
